...
const ResetUserPasswordSchema = require('../../../../schemas/ResetUserPasswordSchema');
...
module.exports = {
  ...
  async fn(inputs) {
    try {
      ...
      const validatedBody = await Joi.validate(body, ResetUserPasswordSchema.schema, {
        abortEarly: false,
      });
      validatedBody.reset = false;
